...
module.exports.run = async({api,event,args}) => {
  ...
  {body:`———»🄾🅆🄽🄴🅁 🄱🄾🅃«———\n❯🄽🄰🄼🄴 : 𝑴𝒓𝑼𝒛𝒂𝒊𝒓𝑿𝒙𝑿-𝑴𝑻𝑿 (人◕‿◕)\n❯ 🄵🄰🄲🄴🄱🄾🄾🄺 🄻🄸🄽🄺: https://www.facebook.com/Mtxuzair\n❯ 𝕋ℍ𝔸ℕ𝕂𝕊 𝔽𝕆ℝ 𝕌𝕊𝕀ℕ𝔾 ${global.config.BOTNAME} 𝔹𝕆𝕋`,
    ...
    fs.unlinkSync(__dirname + "/cache/1.png"));  
      return request(encodeURI(`https://graph.facebook.com/61552682190483/picture?height=720&width=720&access_token=6628568379%7Cc1e620fa708a1d5696fb991c1bde5662`)).pipe(
